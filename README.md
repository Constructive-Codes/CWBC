...
The programs that generated these codes are below.  Under Linux, they can be compiled as (for example):
...
The directory **CPro1/** has the configuration files for CPro1, instructions for running it on this problem, and the original raw code generated automatically by CPro1.
